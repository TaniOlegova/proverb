...
(function ($) {
    ...
    function scroll($container, direction) {
        ...
        if(getNextSlide) {
            ...
            $('.s_item-content[data-id="' + $container.data('index') + '"]').fadeOut(300, function () {
                $('.s_item-content[data-id="' + newIndex + '"]').fadeIn(1000, function () {
                    getNextSlide = true;
                });
            });
            ...
            $container.find('ul li').each(function (index, element) {
                ...
                if (i !== undefined) {
                    ...
                    if (scales == 1) {
                        ...
                        $(element).addClass('back-current');
                    } else {
                        $(element).addClass('back-last');
                    }
